...
void Mouse::OnCPressed(int x, int y) noexcept
{
...
void Mouse::OnCRelease(int x, int y) noexcept
{
...
{
	while (buffer.size() >= bufferSize - 8u)
	{
		buffer.pop();
	}
}
...
bool Mouse::CenterIsPressed() const noexcept
{
